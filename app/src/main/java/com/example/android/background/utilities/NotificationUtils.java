...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        ignoreReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_WATER_COUNT);
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                "No Thanks.",
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        Intent increamentWaterCount = new Intent(context, WaterReminderIntentService.class);
        increamentWaterCount.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        PendingIntent increamentWaterPendingIntent = PendingIntent.getService(
                context,
                ACTION_DRINK_PENDING_INTENT_ID,
                increamentWaterCount,
                PendingIntent.FLAG_CANCEL_CURRENT);

        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "I did it!.",
                increamentWaterPendingIntent);
